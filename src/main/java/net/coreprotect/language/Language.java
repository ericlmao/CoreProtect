...
public class Language {
    ...
    public static void loadPhrases() {
        ...
        phrases.put(Phrase.AUTO_PURGE_COMPLETED, "Automatic purge complete. {0} {row|rows} deleted.");
        phrases.put(Phrase.AUTO_PURGE_SCHEDULED, "Next automatic purge scheduled for {0}, keeping {1} of data.");
        phrases.put(Phrase.AUTO_PURGE_SKIPPED, "Automatic purge skipped; the database is busy.");
        phrases.put(Phrase.AUTO_PURGE_STARTED, "Automatic purge started, removing data older than {0}.");
        ...
        phrases.put(Phrase.DATABASE_LAYOUT_UPGRADED, "Storage layout updated. The previous database was set aside as \"{0}\" and a new one was created.");
        ...
        phrases.put(Phrase.IMPORT_COMPLETED, "Import complete. {0} {row|rows} imported. The source database was renamed to \"{1}\".");
        phrases.put(Phrase.IMPORT_FAILED, "Import failed. Check the server log for details.");
        phrases.put(Phrase.IMPORT_IN_PROGRESS, "A database import is in progress. Please try again later.");
        phrases.put(Phrase.IMPORT_LOW_DISK_SPACE, "The database being imported is {0} and there is {1} free. The import may run out of room before it finishes.");
        phrases.put(Phrase.IMPORT_NOTHING_TO_DO, "There was nothing to import from \"{0}\".");
        phrases.put(Phrase.IMPORT_PATCHES_PENDING, "\"{0}\" was written by an older version of CoreProtect. It is imported in full before the server finishes starting so that the upgrade can run, which takes longer and needs more free disk space.");
        phrases.put(Phrase.IMPORT_PROGRESS, "Importing {0}: {1}% complete.");
        phrases.put(Phrase.IMPORT_SKIPPED_ROWS, "{0} {row|rows} in {1} could not be read from the damaged database and were skipped.");
        phrases.put(Phrase.IMPORT_SKIPPED_TOTAL, "{0} {row|rows} in total could not be read from \"{1}\". Everything the database could still be read for was imported.");
        phrases.put(Phrase.IMPORT_SOURCE_CHANGED, "Cannot resume the import: \"{0}\" is not the file the unfinished import started from.");
        phrases.put(Phrase.IMPORT_SOURCE_DAMAGED, "\"{0}\" is damaged and cannot be read. Import it again from an undamaged copy, or repair it with \"sqlite3 old.db .recover\".");
        phrases.put(Phrase.IMPORT_SOURCE_UNSUPPORTED, "Cannot import \"{0}\": it was not written by an earlier version of CoreProtect.");
        phrases.put(Phrase.IMPORT_STARTED, "Importing the previous CoreProtect database from \"{0}\". Lookups are unavailable until it finishes.");
        phrases.put(Phrase.IMPORT_STOPPED, "Import stopped early. It resumes the next time the server starts.");
        phrases.put(Phrase.IMPORT_TARGET_DAMAGED, "\"{0}\" is damaged. Stop the server, delete it along with its -wal and -shm files, and start again to import into a new one.");
        phrases.put(Phrase.IMPORT_TARGET_NOT_EMPTY, "Cannot import \"{0}\": this database already contains data. Move it aside and restart to import into a new one.");
        ...
        phrases.put(Phrase.STATUS_COLD_DATA, "Cold Data: {0} ({1} {row|rows} compressed).");
